...
*@FileName : Practice2MgmtDBDAOMasterVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice2MgmtDBDAOMasterVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice2MgmtDBDAOMasterVOCSQL(){
		setQuery();
		...
		query.append("FileName : Practice2MgmtDBDAOMasterVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
