...
*@FileName : Practice2MgmtDBDAODetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice2MgmtDBDAODetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice2MgmtDBDAODetailVORSQL(){
		setQuery();
		...
		query.append("FileName : Practice2MgmtDBDAODetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
