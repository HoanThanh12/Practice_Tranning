...
*@FileName : Practice2MgmtDBDAODetailVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice2MgmtDBDAODetailVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice2MgmtDBDAODetailVOCSQL(){
		setQuery();
		...
		query.append("FileName : Practice2MgmtDBDAODetailVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
