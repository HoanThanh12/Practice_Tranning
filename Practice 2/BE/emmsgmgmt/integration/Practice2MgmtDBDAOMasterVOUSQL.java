...
*@FileName : Practice2MgmtDBDAOMasterVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice2MgmtDBDAOMasterVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice2MgmtDBDAOMasterVOUSQL(){
		setQuery();
		...
		query.append("FileName : Practice2MgmtDBDAOMasterVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
