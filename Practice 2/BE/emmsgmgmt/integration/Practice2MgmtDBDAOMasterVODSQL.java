...
*@FileName : Practice2MgmtDBDAOMasterVODSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice2MgmtDBDAOMasterVODSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice2MgmtDBDAOMasterVODSQL(){
		setQuery();
		...
		query.append("FileName : Practice2MgmtDBDAOMasterVODSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
