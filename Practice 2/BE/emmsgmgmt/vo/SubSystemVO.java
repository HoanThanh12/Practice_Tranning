...
*@FileName : SubSystemVO.java
*@FileTitle : SubSystemVO
*Open Issues :
*Change history :
...
package com.clt.apps.opus.practice2.emmsgmgmt.vo;
...
public class SubSystemVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;
	
	private Collection<SubSystemVO> models = new ArrayList<SubSystemVO>();
	...
	public SubSystemVO(String ibflag, String pagerows, String ownrSubSysCd) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return SubSystemVO[]
	 */
	public SubSystemVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return SubSystemVO[]
	 */
	public SubSystemVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		SubSystemVO model = null;
	...
	public SubSystemVO[] getSubSystemVOs(){
		SubSystemVO[] vos = (SubSystemVO[])models.toArray(new SubSystemVO[models.size()]);
		return vos;
	}
