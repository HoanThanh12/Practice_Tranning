...
*@FileName : PRACTICE2_TRN_002.jsp
...
<%@ page import="com.clt.apps.opus.practice2.emmsgmgmt.event.Practice2Trn002Event"%>
<%@ page import="org.apache.log4j.Logger" %>

<%
	Practice2Trn002Event  event = null;					//PDTO(Data Transfer Object including Parameters)
	...
	try {
		event = (Practice2Trn002Event)request.getAttribute("Event");
		...
		strSubSysCd = eventResponse.getETCData("subSystems");
	}catch(Exception e) {
		...
		<div class="opus_design_inquiry">
		    <table>
				...
				<tr>
				   	...
				   	<td width="70"><script type="text/javascript">ComComboObject('s_ownr_sub_sys_cd', 1, 100, 1, 0, 0);</script></td>	   	
					<th width="30">Cd ID</th>
