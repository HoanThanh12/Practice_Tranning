...
*@FileName : Practice3MgmtDBDAODetailVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice3MgmtDBDAODetailVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice3MgmtDBDAODetailVORSQL(){
		setQuery();
		...
		query.append("FileName : Practice3MgmtDBDAODetailVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
