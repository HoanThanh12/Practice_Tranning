...
*@FileName : Practice3MgmtDBDAOSummaryVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class Practice3MgmtDBDAOSummaryVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public Practice3MgmtDBDAOSummaryVORSQL(){
		setQuery();
		...
		query.append("FileName : Practice3MgmtDBDAOSummaryVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("	   AND STL.MODI_COST_CTR_CD = @[trd_cd]" ).append("\n"); 
		query.append("	#end" ).append("\n"); 
