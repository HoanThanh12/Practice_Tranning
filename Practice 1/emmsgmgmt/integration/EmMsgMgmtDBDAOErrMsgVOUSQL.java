...
*@FileName : EmMsgMgmtDBDAOErrMsgVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EmMsgMgmtDBDAOErrMsgVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EmMsgMgmtDBDAOErrMsgVOUSQL(){
		setQuery();
		...
		query.append("FileName : EmMsgMgmtDBDAOErrMsgVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
