...
*@FileName : EmMsgMgmtDBDAOErrMsgVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class EmMsgMgmtDBDAOErrMsgVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EmMsgMgmtDBDAOErrMsgVOCSQL(){
		setQuery();
		...
		query.append("FileName : EmMsgMgmtDBDAOErrMsgVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
