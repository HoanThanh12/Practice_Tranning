...
*@FileName : EmMsgMgmtDBDAOErrMsgVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
* 1.0 Creation
=========================================================*/
package com.clt.apps.opus.esm.clv.training.emmsgmgmt.integration;
...
public class EmMsgMgmtDBDAOErrMsgVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public EmMsgMgmtDBDAOErrMsgVORSQL(){
		setQuery();
		...
		query.append("/*").append("\n"); 
		query.append("Path : com.clt.apps.opus.esm.clv.training.emmsgmgmt.integration").append("\n"); 
		query.append("FileName : EmMsgMgmtDBDAOErrMsgVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
	...
	public void setQuery(){
		...
		query.append("AND   ERR_MSG_CD LIKE '%'||UPPER(@[err_msg_cd])||'%'" ).append("\n"); 
